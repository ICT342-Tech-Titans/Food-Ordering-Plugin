			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Special Menu</h2>
						<p>Our Special Menu you can buy any product from here.</p>
					</div>
				</div>
			</div>
					...
					<div class="tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
							<div class="row">
								...
								$Price = $row["Price"]; 
								//$Date = $row["addedDateTime"]; 
							
								?>
								<a href="single-item.php?ItemId=<?php echo $row["ItemId"];?>"><div class="col-lg-4 col-md-6 special-grid drinks">
									<div class="gallery-single fix">
										<img style="height:200px;width:100%;" src="admin/itemimage/<?php echo $image; ?>" class="img-fluid" alt="Image">
										<div class="why-text">
